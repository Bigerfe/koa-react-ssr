...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (function ({\n  getState,\n  dispatch\n}) {\n  return next => action => {\n    console.log('m1 pre state', getState()); // 调用 middleware 链中下一个 middleware 的 dispatch。\n\n    next(action);\n    console.log('m1 after dispatch', getState());\n  };\n});\n\n//# sourceURL=webpack:///./src/share/redux/test-m1.js?");
