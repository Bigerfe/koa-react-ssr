...
export default  async (ctx,next)=>{
    ...
    const html = renderToString(<Provider initialData={fetchResult||{}}>
        <StyleContext.Provider value={{ insertCss }} ><StaticRouter location={path} context={context}><App routeList={staticRoutesList}></App></StaticRouter></StyleContext.Provider>
    </Provider>);
